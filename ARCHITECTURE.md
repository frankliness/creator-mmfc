...
3. `admin/server` + `admin/web`
   管理后台。后端基于 Fastify，前端基于 Vue 3 + Ant Design Vue，负责用户、项目、任务、Prompt、全局配置、审计等运营能力。**v1.8.0 起支持细粒度权限管理系统（14 分栏 × 2 操作）**。
4. `MMFC-canvas/`
...
当前代码基线相比 v1.7.1，完成了管理后台的权限管理系统重构：
