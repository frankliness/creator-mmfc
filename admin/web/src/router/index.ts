...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: "user-action-logs", name: "UserActionLogs", component: () => import("@/views/user-action-log/index.vue"), meta: { title: "用户操作日志" } },
      { path: "audit-logs", name: "AuditLogs", component: () => import("@/views/audit-log/index.vue"), meta: { title: "审计日志" } },
      { path: "system/credentials", name: "Credentials", component: () => import("@/views/system/credentials.vue"), meta: { title: "凭据池", role: "SUPER_ADMIN" } },
      { path: "system/defaults", name: "Defaults", component: () => import("@/views/system/defaults.vue"), meta: { title: "默认模型", role: "SUPER_ADMIN" } },
      { path: "system/model-registry", name: "ModelRegistry", component: () => import("@/views/system/model-registry.vue"), meta: { title: "模型注册表", role: "SUPER_ADMIN" } },
      { path: "system/providers", name: "Providers", component: () => import("@/views/system/providers.vue"), meta: { title: "Provider 配置（已迁移）", role: "SUPER_ADMIN" } },
